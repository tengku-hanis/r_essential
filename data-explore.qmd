...
3.  Using the `riskfactors` dataset in question 2), emove all missing values in the dataset and determine how many rows are left.
...
7.  Name three packages for data exploration besides the five packages covered in this chaer.
